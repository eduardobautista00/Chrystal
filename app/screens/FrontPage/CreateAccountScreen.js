...
export default function CreateAccountScreen({ route, navigation }) {
  ...
  const validateInputs = () => {
    if (!termsAndPolicy) {
      Alert.alert('Agreement Required', 'Please agree to the Terms and Privacy Policy to continue.');
      return false;
    }
      ...
      <AnimatedBackground>
        ...
        <PhoneInput 
                ...
                setPhone={(newPhoneState) => {
                    ...
                    if (newPhoneState.value) {
                        setPhone({ ...newPhoneState, error: '' });
                    } else {
                        setPhone(newPhoneState);
                    }
                }}
        ...
        <View style={styles.row}>
          <View style={styles.checkboxContainer}>
            <Checkbox
              status={termsAndPolicy ? "checked" : "unchecked"}
              onPress={() => setTermsAndPolicy(!termsAndPolicy)}
